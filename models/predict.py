...
weights_path = os.path.join(root_path, 'weights/new_10_classes/InceptionV3_10_classes_without_fc.h5')
test_data_dir = os.path.join(root_path, 'data/process_imgsize400/test')
