...
class LossHistory(keras.callbacks.Callback):
    ...
    def loss_plot(self, loss_type):
        ...
        plt.savefig(model_dir + "lenet_10_cls_256_pre_{}_{}.png".format(batch_size, nbr_epochs))
...
if __name__ == '__main__':
    ...
    best_model_file = model_dir + "lenet_10_cls_256_weights.h5"
    ...
    plt.savefig('confusion_matrix_lenet_256.png', format='png')
    # plt.show()
